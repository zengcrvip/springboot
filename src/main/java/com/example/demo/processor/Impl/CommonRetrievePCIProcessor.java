 ...
 * @Date: Created in 19:57 2018/8/16 .
 */
@Order(1)
@Service
public class CommonRetrievePCIProcessor extends PciProcessorUnit {
    private static final Logger log = LogManager.getLogger(CommonRetrievePCIProcessor.class);

    @Override
    protected boolean doProcess(ProcessContext ctx) throws AppBizException {
        log.info("this is CommonRetrievePCIProcessor first--------------------");
        return true;
    }
}
